...
class FermiHubbardTest(unittest.TestCase):
    ...
    def test_two_by_two_spinless(self):
        ...
        self.assertAlmostEqual(
            hubbard_model.terms[((1, 1), (0, 1), (1, 0), (0, 0))], -1.)
        self.assertAlmostEqual(
            hubbard_model.terms[((3, 1), (2, 1), (3, 0), (2, 0))], -1.)

        # Check top/bottom Coulomb terms.
        self.assertAlmostEqual(
            hubbard_model.terms[((2, 1), (0, 1), (2, 0), (0, 0))], -1.)
        self.assertAlmostEqual(
            hubbard_model.terms[((3, 1), (1, 1), (3, 0), (1, 0))], -1.)

        # Check that there are no other Coulomb terms.
        self.assertNotIn(((3, 1), (0, 1), (3, 0), (0, 0)),
                         hubbard_model.terms)
        self.assertNotIn(((2, 1), (1, 1), (2, 0), (1, 0)),
                         hubbard_model.terms)
