...
class DiagonalHamiltonianCommutatorTest(unittest.TestCase):
    ...
    def test_commutator(self):
        operator_a = (
            ...
            FermionOperator('2^ 0^ 2 0', .126j) + FermionOperator('4^ 2^ 4 2') +
        ...
        operator_b = (
            ...
            FermionOperator('3^ 1^ 3 1', -1.37) + FermionOperator('4^ 2^ 4 2') +
            FermionOperator('4^ 1^ 4 1') + FermionOperator('1^ 0^ 4 0', 16.7) +
