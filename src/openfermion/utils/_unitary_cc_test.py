...
class UnitaryCC(unittest.TestCase):
    ...
    def test_uccsd_singlet_builds(self):
        ...
        test_generator = (FermionOperator("2^ 0", 2.) +
                          FermionOperator("0^ 2", -2.) +
                          FermionOperator("3^ 1", 2.) +
                          FermionOperator("1^ 3", -2.) +
        ...
        test_generator = (FermionOperator("2^ 0", 2.) +
                          ...
                          FermionOperator("3^ 1", 2.) +
                          FermionOperator("1^ 3", -2.) +
                          FermionOperator("4^ 0", 4.) +
                          FermionOperator("0^ 4", -4) +
                          FermionOperator("5^ 1", 4.) +
                          FermionOperator("1^ 5", -4.) +
                          FermionOperator("2^ 0 3^ 1", 6.) +
                          FermionOperator("1^ 3 0^ 2", -6.) +
                          FermionOperator("4^ 0 5^ 1", 8.) +
                          FermionOperator("1^ 5 0^ 4", -8.) +
                          FermionOperator("2^ 0 5^ 1", 10.) +
                          FermionOperator("1^ 5 0^ 2", -10.) +
                          FermionOperator("4^ 0 3^ 1", 10.) +
                          FermionOperator("1^ 3 0^ 4", -10.) +
                          FermionOperator("2^ 0 4^ 0", 10.) +
                          FermionOperator("0^ 4 0^ 2", -10.) +
                          FermionOperator("3^ 1 5^ 1", 10.) +
                          FermionOperator("1^ 5 1^ 3", -10.))
