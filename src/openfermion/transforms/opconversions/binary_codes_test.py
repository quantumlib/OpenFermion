...
from openfermion.transforms.opconversions import (binary_code_transform,
                                                  bravyi_kitaev,
...
from openfermion.transforms.opconversions.binary_codes import (
    ...
    parity_code, weight_one_binary_addressing_code, weight_one_segment_code,
    weight_two_segment_code, linearize_decoder)
