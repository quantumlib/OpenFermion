...
class GetNumberPreservingSparseOperatorIntegrationTestLiH(unittest.TestCase):
    ...
    def test_ground_state_energy(self):
        ...
        eig_val, __ = scipy.sparse.linalg.eigsh(sparse_ham, k=1, which='SA')
    ...
    def test_cisd_matches_fci_energy_two_electron_hubbard(self):
        ...
        eig_val_cisd, __ = scipy.sparse.linalg.eigsh(sparse_ham_cisd,
                                                     k=1,
                                                     which='SA')
        eig_val_fci, __ = scipy.sparse.linalg.eigsh(sparse_ham_fci,
                                                    k=1,
                                                    which='SA')
